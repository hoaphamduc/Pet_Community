...
public class ProfileFriendActivity extends AppCompatActivity {
    ...
    private Button notification, sendMessage, showmore;
    private RecyclerView recyclerViewPosts;
    private PostAdapter postAdapter;
    private List<Post> postList;
    private String savedUsername, avatarUrl, savedUsernameLogedin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showmore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileFriendActivity.this, ShowMoreInfomationActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        postAdapter.setOnItemClickListener(new PostAdapter.OnItemClickListener() {
            ...
            public void onEditClick(int position) {
                if (!savedUsername.equals(savedUsernameLogedin)) {
                    return;
                }
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileFriendActivity.this,NewFeedsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileFriendActivity.this,MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileFriendActivity.this,SorryActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ProfileFriendActivity.this,MessageActivity.class);
                intent.putExtra("recipientId", savedUsername);
                startActivity(intent);
                finish();
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileFriendActivity.this,ProfileActivity.class);
                startActivity(intent);
                finish();
            }
        });
                        ...
                        if (!TextUtils.isEmpty(status) && rotatedBitmap != null) {
                            ...
                            uploadTask.addOnSuccessListener(taskSnapshot -> {
                                imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                                    ...
                                    Toast.makeText(ProfileFriendActivity.this, "Posted successfully!", Toast.LENGTH_SHORT).show();
                                });
                            }).addOnFailureListener(e -> {
                                // Xử lý lỗi khi tải lên Firebase Storage.
                                e.printStackTrace();
                                Toast.makeText(ProfileFriendActivity.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                            });
                        } else {
                            // Thông báo lỗi nếu status hoặc ảnh trống
                            Toast.makeText(ProfileFriendActivity.this, "Please enter status and select image!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        postsRef.orderByChild("savedUsername").equalTo(targetUsername).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(ProfileFriendActivity.this, "No posts found for " + targetUsername, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(ProfileFriendActivity.this, "Error fetching posts: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (post != null) {
                        ...
                        Toast.makeText(ProfileFriendActivity.this, "Post deleted successfully", Toast.LENGTH_SHORT).show();
    ...
    private void editPost(String postId) {
        ...
        // For example:
        Intent intent = new Intent(ProfileFriendActivity.this, EditPostActivity.class);
    ...
    private void openFullscreenActivity(int position) {
        ...
        Intent intent = new Intent(ProfileFriendActivity.this, FullScreenImageActivity.class);
